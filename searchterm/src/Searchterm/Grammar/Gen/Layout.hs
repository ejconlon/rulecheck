...
module Searchterm.Grammar.Gen.Layout where
...
layoutSep   = List.nub $ TokSymbol ";" 1 : map (delimSep . snd) layoutWords
...
resolveLayout topLayout =
  ...
  topDelim = LayoutDelimiters (TokSymbol ";" 1) Nothing Nothing
